...
An Interactive Shell for SQLite3.

I took inspiration from [http://gadfly.sourceforge.net/gfplus.html gfplus] available on Gadfly CVS: [http://gadfly.cvs.sourceforge.net/gadfly/gadfly/gadfly/scripts/gfplus.py?view=markup source code of 'gfplus.py'].
...
def main(userlocation=None):
    if userlocation:
        shell = SQLiteShell(userlocation)
    else:
