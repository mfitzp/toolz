...
class DataClass(object):
    def __init__(self, xdata,  ydata, name = None, path = None, interp = False, normOk = False, smoothOk = False):
        self.x = xdata
        if ydata != None:
            self.y = ydata
        else:
...
#            self.interpData()
    ...
    def smooth(self):
        if self.smthY != None:
            ...
            self.smthY = smoothF.savitzky_golay(self.y)
            return self.smthY
