...
class Ui_fingerPlotWidget(object):
    def setupUi(self, fingerPlotWidget):
        ...
        self.gridlayout1.addLayout(self.hboxlayout,0,2,1,1)
        ...
        self.gridlayout1.addLayout(self.hboxlayout3,2,2,1,1)

        self.fingerPrint_Btn = QtGui.QPushButton(self.tab)
        self.fingerPrint_Btn.setObjectName("fingerPrint_Btn")
        self.gridlayout1.addWidget(self.fingerPrint_Btn,0,1,1,1)
        ...
        self.hboxlayout4.addWidget(self.freqCutoff_SB)
        self.gridlayout1.addLayout(self.hboxlayout4,1,1,1,1)
        ...
        self.hboxlayout5.addWidget(self.minSpectra_SB)
        self.gridlayout1.addLayout(self.hboxlayout5,2,1,1,1)
        ...
        self.hboxlayout6 = QtGui.QHBoxLayout(self.tab_3)
        self.hboxlayout6.setObjectName("hboxlayout6")

        self.peakTable = CustomTable(self.tab_3)
        self.peakTable.setObjectName("peakTable")
        self.hboxlayout6.addWidget(self.peakTable)
