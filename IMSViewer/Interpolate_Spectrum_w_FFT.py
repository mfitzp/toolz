...
from Savitsky_Golay_Filter import savitzky_golay
...
def fft_spectrum(evenly_spaced_y_data):#idealy this is the y_new from the previous function
    ...
    result_dict={}
    result_dict['fft_result'] = fft_result
    result_dict['fft_mag'] = mag
    result_dict['freq_array'] =freqArray/1000#put in kHz
