...
#
# Created: Tue Mar  3 07:00:07 2009
...
class Ui_fingerPlotWidget(object):
    def setupUi(self, fingerPlotWidget):
        ...
        self.gridlayout.addLayout(self.hboxlayout, 0, 2, 1, 1)
        ...
        self.gridlayout.addLayout(self.hboxlayout3, 2, 2, 1, 1)
        self.fingerPrint_Btn = QtGui.QPushButton(self.tab)
        self.fingerPrint_Btn.setObjectName("fingerPrint_Btn")
        self.gridlayout.addWidget(self.fingerPrint_Btn, 0, 1, 1, 1)
