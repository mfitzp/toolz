...
#
# Created: Sat Nov  7 22:41:40 2009
...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.formula1_CB = QtGui.QCheckBox(self.calcTab)
        self.formula1_CB.setObjectName("formula1_CB")
        self.horizontalLayout_2.addWidget(self.formula1_CB)
        self.formulaInput1 = QtGui.QLineEdit(self.calcTab)
        self.formulaInput1.setObjectName("formulaInput1")
        self.horizontalLayout_2.addWidget(self.formulaInput1)
        self.calcFormula1_Btn = QtGui.QToolButton(self.calcTab)
        self.calcFormula1_Btn.setObjectName("calcFormula1_Btn")
        self.horizontalLayout_2.addWidget(self.calcFormula1_Btn)
        self.formula1_MW_LE = QtGui.QLineEdit(self.calcTab)
        self.formula1_MW_LE.setReadOnly(True)
        self.formula1_MW_LE.setObjectName("formula1_MW_LE")
        self.horizontalLayout_2.addWidget(self.formula1_MW_LE)
        ...
        self.formula2_CB = QtGui.QCheckBox(self.calcTab)
        self.formula2_CB.setObjectName("formula2_CB")
        self.horizontalLayout_4.addWidget(self.formula2_CB)
        self.formulaInput2 = QtGui.QLineEdit(self.calcTab)
        self.formulaInput2.setObjectName("formulaInput2")
        self.horizontalLayout_4.addWidget(self.formulaInput2)
        self.calcFormula2_Btn = QtGui.QToolButton(self.calcTab)
        self.calcFormula2_Btn.setObjectName("calcFormula2_Btn")
        self.horizontalLayout_4.addWidget(self.calcFormula2_Btn)
        self.formula2_MW_LE = QtGui.QLineEdit(self.calcTab)
        self.formula2_MW_LE.setReadOnly(True)
        self.formula2_MW_LE.setObjectName("formula2_MW_LE")
        self.horizontalLayout_4.addWidget(self.formula2_MW_LE)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.formula1_CB.setText(QtGui.QApplication.translate("MainWindow", "Forumla 1:", None, QtGui.QApplication.UnicodeUTF8))
        self.calcFormula1_Btn.setText(QtGui.QApplication.translate("MainWindow", "...", None, QtGui.QApplication.UnicodeUTF8))
        self.label.setText(QtGui.QApplication.translate("MainWindow", "g/mol", None, QtGui.QApplication.UnicodeUTF8))
        self.formula2_CB.setText(QtGui.QApplication.translate("MainWindow", "Formula 2:", None, QtGui.QApplication.UnicodeUTF8))
        self.calcFormula2_Btn.setText(QtGui.QApplication.translate("MainWindow", "...", None, QtGui.QApplication.UnicodeUTF8))
