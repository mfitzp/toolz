...
__revision__=" $Id: shell.py,v 1.1.1.1 2007/12/22 21:27:18 rada_ameba Exp $"
...
#         self.resize(request)
    ...
    def __run(self):
        """
        Append the last line to the list, let the interpreter execute
    ...
    def keyPressEvent(self, e):
        ...
        if key == Qt.Key_Backspace:
            ...
            if self.reading:
                ...
                self.__run()
                self.emit(QtCore.SIGNAL("shellNewLine"), ())
