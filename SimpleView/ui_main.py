...
#
# Created: Fri Feb 13 13:06:08 2009
...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.vboxlayout3.addWidget(self.autoSavePkList_CB)
        ...
        self.gridlayout1.addLayout(self.vboxlayout3,5,0,1,2)
        ...
        self.vboxlayout4.addLayout(self.hboxlayout19)
        self.gridlayout1.addLayout(self.vboxlayout4,5,2,1,1)
        ...
        self.hboxlayout20.addLayout(self.vboxlayout6)

        spacerItem8 = QtGui.QSpacerItem(40,20,QtGui.QSizePolicy.Expanding,QtGui.QSizePolicy.Minimum)
        self.hboxlayout20.addItem(spacerItem8)
        self.gridlayout1.addLayout(self.hboxlayout20,5,3,1,1)
        ...
        self.layoutWidget1.setGeometry(QtCore.QRect(70,110,173,25))
        self.layoutWidget1.setObjectName("layoutWidget1")

        self.hboxlayout21 = QtGui.QHBoxLayout(self.layoutWidget1)
        self.hboxlayout21.setObjectName("hboxlayout21")

        self.label_18 = QtGui.QLabel(self.layoutWidget1)
        self.label_18.setObjectName("label_18")
        self.hboxlayout21.addWidget(self.label_18)

        self.spinBox = QtGui.QSpinBox(self.layoutWidget1)
        self.spinBox.setObjectName("spinBox")
        self.hboxlayout21.addWidget(self.spinBox)

        self.layoutWidget_2 = QtGui.QWidget(self.tab)
        self.layoutWidget_2.setGeometry(QtCore.QRect(70,70,173,25))
        self.layoutWidget_2.setObjectName("layoutWidget_2")

        self.hboxlayout22 = QtGui.QHBoxLayout(self.layoutWidget_2)
        self.hboxlayout22.setObjectName("hboxlayout22")

        self.test = QtGui.QLabel(self.layoutWidget_2)
        self.test.setAlignment(QtCore.Qt.AlignRight|QtCore.Qt.AlignTrailing|QtCore.Qt.AlignVCenter)
        self.test.setObjectName("test")
        self.hboxlayout22.addWidget(self.test)

        self.test2 = QtGui.QSpinBox(self.layoutWidget_2)
        self.test2.setObjectName("test2")
        self.hboxlayout22.addWidget(self.test2)
