...
#        self.wordList = ['alpha', 'alpaca', 'alphabet','omega', 'omicron',  'zeta',  'zetta', 'my', 'mom',  'told',  'you'] 
...
#        #QObject.connect(self.completer,  SIGNAL("highlighted(QString)"), self.setCurSelection)
#    
#    def setCurSelection(self,  selection):
...
#        tc = self.textCursor()
#        completionPrefix = self.textUnderCursor()#new
#        #extra = completion.length() - self.completer.completionPrefix().length()
#        extra = completion.length() - completionPrefix.length()
...
##                    print "Return"
#                    
#                    QObject.emit(self.completer, SIGNAL("highlighted(QString)"), self.insertCompletion)
#                    #print str(self.curSelection)
#                    #self.insertCompletion(self.curSelection)
#                    #event.ignore()
