...
def Find_Peaks(data_array):
    ...
    smoothed_data=savitzky_golay(y_data, kernel = 15, order = 3)
    #d=savitzky_golay(first_derivative(smoothed_data), kernel = 11, order = 4)
    d = derivative(y_data)#smoothed_data)
